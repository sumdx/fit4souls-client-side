...
const Community = () => {
  ...
  const [allForumsData, refetch] = useAllComunityPost(currentPage, itemPerPage);
  ...
  useEffect(()=>{
    setNumberOfPages(Math.ceil(allForumsData?.length/itemPerPage))
          ...
          </li>
          {
            ...
            <a
              ...
              className={(currentPage === page+1)?
                "flex items-center justify-center px-4 h-10 leading-tight text-white bg-blue-300 border border-gray-300 hover:bg-blue-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                :
                "flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              }
             >
              {page+1}
            </a>
