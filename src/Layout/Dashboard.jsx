      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            ...
            <li>
                <NavLink to={"/dashboard/balance"} className="flex items-center text-xl">
                <MdSettingsApplications class="text-4xl w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
            ...
            <li>
                <NavLink to={"/dashboard/add-new-class"} className="flex items-center text-xl">
                <MdSettingsApplications class="text-4xl w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
            ...
            {/* Trainers part */}
            <li>
                <NavLink to={"/dashboard/manage-slots"} className="flex items-center text-xl">
                <MdSettingsApplications class="text-4xl w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
            ...
            <li>
                <NavLink to={"/dashboard/add-new-slot"} className="flex items-center text-xl">
                <MdSettingsApplications class="text-4xl w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
            ...
            <li>
                <NavLink to={"/dashboard/booked-trainer"} className="flex items-center text-xl">
                <MdSettingsApplications class="text-4xl w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
